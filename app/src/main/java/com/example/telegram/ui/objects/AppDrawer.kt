...
class AppDrawer {
    ...
    fun enableDrawer() {
        ...
        APP_ACTIVITY.supportActionBar?.title ="Команда мастеров"
        ...
        mDrawer = DrawerBuilder()
            ...
            .addDrawerItems(
                ...
                PrimaryDrawerItem().withIdentifier(109)
                    .withIconTintingEnabled(true)
                    .withName("Вопросы о приложении КМ")
                    .withSelectable(false)
